    ...
    <Link to={/space?id=\}>
      ...
      >
        <div className="relative h-48 overflow-hidden">
          <img
            src={space.image || "https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&q=80"}
            alt={space.name}
        ...
        <div className="p-5">
          ...
          <div className="flex items-center justify-between pt-4 border-t border-slate-50">
            ...
            <div className="text-right">
              <span className="text-xs text-slate-400 block uppercase tracking-wider font-semibold">A partir de</span>
              <span className="text-lg font-bold text-blue-600">R$ {space.pricePerHour}</span>
