  ...
  return (
    <div className="bg-white rounded-[32px] border border-gray-100 shadow-sm p-6 mb-8">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h2 className="text-lg font-black text-gray-900 tracking-tighter">Buscar Espaços</h2>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="relative">
          ...
          <Input
            ...
            className="pl-12 h-12 rounded-2xl border-gray-100 focus:ring-teal-500"
          />
        </div>
        ...
        >
          ...
          <SelectContent className="rounded-2xl">
            <SelectItem value="todos text-gray-400 font-bold">Todos os tipos</SelectItem>
            <SelectItem value="piscina">Piscina</SelectItem>
            <SelectItem value="chacara">Chácara</SelectItem>
            <SelectItem value="salao_festas">Salão de Festas</SelectItem>
            <SelectItem value="quadra_esportes">Quadra Esportiva</SelectItem>
            <SelectItem value="espaco_eventos">Espaço para Eventos</SelectItem>
            <SelectItem value="area_camping">Área de Camping</SelectItem>
