  ...
  return (
    <div className="min-h-screen bg-[#FDFCFB] pb-20">
      <main className="pt-32 px-6 lg:px-20 max-w-[1600px] mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex items-start gap-3">
                ...
                <p className="text-xs font-black uppercase tracking-widest text-slate-400 leading-relaxed">
                  <span className="text-black block text-sm mb-1 font-black">DONOS DE ÁREA:</span> 
                  AUMENTE SUA OCUPAÇÃO COM SERVIÇOS QUE VALORIZAM SEU ESPAÇO E GERAM MAIS RESERVAS.
                </p>
              </div>
              <div className="flex items-start gap-3">
                <CheckCircle2 size={24} className="text-[#00BFA6] mt-1 shrink-0" />
                <p className="text-xs font-black uppercase tracking-widest text-slate-400 leading-relaxed">
                  ...
                  ESTEJA ONDE OS CLIENTES ESTÃO. AGENDA CHEIA, CONEXÕES FORTES E PARCERIAS DE SUCESSO.
                </p>
              </div>
            </div>
          </div>
        ...
        {/* GRADE DE 4 COLUNAS COM TODOS OS 12 SERVIÇOS */}
