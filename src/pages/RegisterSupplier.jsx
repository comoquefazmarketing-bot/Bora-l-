            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-start gap-2 text-left">
                ...
                <p className="text-xs font-black uppercase tracking-tight text-slate-400">
                  <span className="text-black">DONOS DE áREA:</span> AUMENTE SUA OCUPAá€¡ÃƒÆ’O COM SERVIá€¡OS QUE VALORIZAM SEU ESPAá€¡O.
                </p>
              </div>
              <div className="flex items-start gap-2 text-left">
                <CheckCircle2 size={18} className="text-[#00BFA6] mt-1 shrink-0" />
                <p className="text-xs font-black uppercase tracking-tight text-slate-400">
                  <span className="text-black">PRESTADORES:</span> ESTEJA ONDE OS CLIENTES ESTÃƒÆ’O. AGENDA CHEIA E PARCERIAS FORTES.
                </p>
              </div>
            </div>
          </div>
