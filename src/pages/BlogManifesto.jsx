      ...
      <header className="relative py-20 px-6 overflow-hidden bg-gradient-to-b from-[#242424] to-[#1a1a1a]">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-gray-400 text-lg md:text-xl font-medium max-w-2xl mx-auto italic">
            "Transformando a organização de eventos de algo subjetivo e disperso em uma experiência moderna e eficiente."
          </p>
        </div>
      </header>
      ...
      <main className="max-w-3xl mx-auto px-6 pb-24 space-y-16">
        ...
        <section className="space-y-4">
          ...
          <p className="text-gray-300 leading-relaxed text-lg">
            Com o Bora Lá, você encontra diversas áreas de lazer catalogadas com imagens, localizações, preços e comodidades em um só lugar. Isso significa:
          </p>
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
            {['Comparar opções rapidamente', 'Ver informações detalhadas sem perguntar', 'Economizar tempo na escolha ideal'].map((item, i) => (
        ...
        <section className="bg-[#242424] p-8 rounded-[2rem] border border-white/5 shadow-2xl">
          ...
          <p className="text-gray-300 leading-relaxed text-lg">
            Em vez de perguntar para cada proprietário se a data desejada está disponível, o Bora Lá permite que você consulte datas diretamente no app — tudo organizado e padronizado.
          </p>
        </section>
        ...
        <section className="border-t border-white/10 pt-12 space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {['DJs e Músicos', 'Buffet', 'Decoração', 'Gelo e Bebidas'].map((s) => (
        ...
        <section className="space-y-8">
          <div className="flex items-center gap-3 text-[#c4a457]">
            <Users size={24} />
            <h2 className="text-2xl font-black uppercase italic">Uma ferramenta útil para todos</h2>
          </div>
